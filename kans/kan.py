...
class KAN(nn.Module):  # Kolmogorov Arnold Network
...
class KALN(nn.Module):  # Kolmogorov Arnold Legendre Network
...
class FastKAN(nn.Module): # Kolmogorov Arnold RBF Network
    def __init__(
            self,
...
class KACN(nn.Module):  # Kolmogorov Arnold Chebyshev Network 
...
class KAGN(nn.Module): # Kolmogorov Arnold Gram Network
    def __init__(self, layers_hidden, dropout: float = 0.0, l1_decay: float = 0.0, degree=3,
                 base_activation=nn.SiLU, first_dropout: bool = True, **kwargs):
...
class BottleNeckKAGN(nn.Module): # Bottleneck Kolmogorov Arnold Gram Network
    def __init__(self, layers_hidden, dropout: float = 0.0, l1_decay: float = 0.0, degree=3,
...
class KABN(nn.Module): # Kolmogorov Arnold Bernstein Network
    def __init__(self, layers_hidden, dropout: float = 0.0, l1_decay: float = 0.0, degree=3,
                 base_activation=nn.SiLU, first_dropout: bool = True, **kwargs):
...
class KAJN(nn.Module): # Kolmogorov Arnold Jacobi Network
...
class WavKAN(nn.Module): # Kolmogorov Arnold Wavelet Network
    def __init__(self, layers_hidden, dropout: float = 0.0, l1_decay: float = 0.0,
...
class ReLUKAN(nn.Module): # Kolmogorov Arnold ReLU Network
